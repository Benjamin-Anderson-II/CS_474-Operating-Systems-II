...
{
  check(*(uint64 *)arg1 == 0xABCDABCD, "*arg1 is incorrect");
  check(*(uint64 *)arg2 == 0xCDEFCDEF, "*arg2 is incorrect");

  // Change external state
  *(uint64 *)arg1 = 0x12341234;
  cpid = getpid();
...
{
  void *stack1, *stack2;
  uint64 arg1 = 0xABCDABCD;
  uint64 arg2 = 0xCDEFCDEF;
  ...
  pid1 = clone(func, (uint64)&arg1, (uint64)&arg2, stack1);
